...
public class payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispense.setVisibility(View.INVISIBLE);
        clientId = MqttClient.generateClientId();
        options = new MqttConnectOptions();
        client = new MqttAndroidClient(this.getApplicationContext(), "ssl://io.adafruit.com:8883",
                clientId);
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(payment.this)) {
            ...
            if (status.equals("success")) {
                ...
                dispense.setVisibility(View.VISIBLE);
            }
    ...
    public void pub(View v){
        String topic = "senprithwish1994/feeds/helloio1";
        String payload = "on";
